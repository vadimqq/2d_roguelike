...
var module_tex = preload("res://UI/inventory/slot/module_cell.png")
var weapon_tex = preload("res://UI/inventory/slot/weapon_slot.png")
var item_tex = preload("res://UI/inventory/slot/item_slot.png")
